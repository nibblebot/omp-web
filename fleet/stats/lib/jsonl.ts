 ...
 */
export function toolExecutionStart(e: RawEntry): { toolCallId: string; startedAtMs: number } | null {
...
export function isToolResult(e: RawEntry): e is RawEntry & { message: { role: "toolResult"; toolCallId: string } } {
