...
function Prov(props: { src: "live" | "db" }) {
  return (
    <span
      ...
      title={
        props.src === "live"
          ? "computed from the live session JSONL"
          : "from stats.db"
      }
    >
      {props.src}
    ...
    <>
      ...
      <div class="cards">
        ...
        <div class="tx-card">
          ...
          <div class="value" title={longest() ? `${longest()!.toolName} · ${longest()!.toolCallId}` : undefined}>
        ...
        <div class="tx-card">
          ...
          <div classList={{ value: true, "value-err": s().errors.length > 0 }}>{s().errors.length}</div>
      ...
      <div class="panels">
        <section class="panel">
          ...
          <Show when={s().tools.length > 0} fallback={<div class="muted">No tool calls in this session.</div>}>
                  ...
                  {(t) => (
                    <>
                      ...
                      >
                        ...
                        <td classList={{ num: true, "num-err": t.errors > 0 }}>{t.errors > 0 ? t.errors : ""}</td>
        ...
        <section class="panel">
          ...
          <div class="muted small">Tool durations are execution spans (tool start → result); calls without an execution-start marker show no duration.</div>
        </section>
